...
catalogo = {
    "Activo circulante": [
        "Caja-Efectivo", "Bancos", "Cuentas por cobrar", "Documentos por cobrar", "Inventario", "Inventario Final",
        "Gastos pagados por adelantado", "Deudores diversos", "Clientes"
    ],
    "Activo no circulante": [
        "Terrenos", "Edificios", "Equipo de reparto", "Equipo de computo",
        "Mobiliario y equipo", "Equipo de computo"
    ],
    "Pasivo a corto plazo": [
        "Cuentas por pagar", "Intereses por pagar", "Proveedores",
        "Sueldos por pagar", "Documentos por pagar", "Acreedores diversos"
    ],
...
def PaginaIng(frame_menu, ventana):
    ...
    tk.Label(op_frame, text="OPERACIÓN", bg="#d0e0ff", fg="#003366", font=("Minecraftia", 10, "bold")).pack(side="left",
                                                                                                            padx=5)
